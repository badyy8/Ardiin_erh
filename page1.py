...
with tab3:
    ...
    with st.expander(expanded=True,label= 'Тайлбар:'):
        ...
        st.markdown(f"""
        - Сард дунджаар **{reached_1000_df['1000 оноо хүрсэн'].mean():.1f}** хэрэглэгч 1000 онооны босгыг давсан нь,
...
with tab1:
    ...
    with st.expander(expanded=True, label='Тайлбар:'):
        ...
        st.markdown(f"""
        - 2025 оны **1–12** дугаар саруудад нийт **55,130** хэрэглэгч урамшууллын хөтөлбөрт хамрагдсан байна.
        - Сард дунджаар **16,297** хэрэглэгч урамшуулалд оролцсон байна.
        """)
